...
print("The average age of the players is \(avgAge)")
...
print("The average height of the players is \(avgFeet) feet \(avgIns) inch")
...
print("The month with the most Blackhawks players birthdays is \(mostFrequentMonth).")
